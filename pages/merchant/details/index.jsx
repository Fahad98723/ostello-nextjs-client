          ...
          <div className="h-fit rounded-[10px] flex items-center justify-center md:max-w-[810px] bg-[#F7F5FD] w-full lg:w-4/6 lg:px-12 py-2 lg:py-12 mt-4">
            ...
            {page === 2 && (
              <CourseDetails
                ...
                graduationStreamsState={[graduationStreams, setGraduationStreams]}
                graduationCoursesState={[graduationCourses, setGraduationCourses]}
                postStreamsState={[postGraduationStreams, setPostGraduationStreams]}
                postGraduationCoursesState={[
                  postGraduationCourses, setPostGraduationCourses
                ]}

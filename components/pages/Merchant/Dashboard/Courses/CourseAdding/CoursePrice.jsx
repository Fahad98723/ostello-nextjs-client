...
const CoursePriceAndCoupens = ({
  ...
  const handleSubmit = (e) => {
    ...
    if (isEmpty(selectedId)) {
      ...
      dispatch(
        addCoursePrice({
          grossPriceValue: Number(yearlyGrossPrice),
          minimumPriceValue: Number(yearlyMinPrice),
          discPriceValue: Number(yearlyDiscPrice),
          effectivePriceValue: Number(yearlyEffPrice),
          emiPriceValue: Number(yearlyEffPrice),
          coupon: selectedId,
        })
      );
      ...
      {priceFre === "Partial" ? (
        ...
        <>
          ...
          >
            ...
            <input
              type="number"
              onBlur={(e) => setOneTimeDiscPrice(e.target.value)}
              className="text-slate text-lg px-3 bg-transparent  placeholder-ghost w-full focus:outline-none"
          ...
          <div className="flex flex-col lg:flex-row gap-5 mb-5 lg:mb-0 lg:gap-16 mt-5">
            <div className="">
              ...
              >
                ...
                <input
                  type="number"
                  onBlur={(e) => setOneTimeMinPrice(e.target.value)}
                  className="text-slate text-lg px-3 bg-transparent  placeholder-ghost w-full focus:outline-none"
            ...
            <div className="">
              ...
              >
                ...
                <input
                  type="number"
                  onBlur={(e) => setOneTimeEffPrice(e.target.value)}
                  className="text-slate text-lg px-3 bg-transparent  placeholder-ghost w-full focus:outline-none"
      ...
      {admin ? (
        <div className="flex flex-col lg:flex-row gap-5 mb-5 lg:mb-0 lg:gap-16 mt-5">
          <div className="">
            ...
            <h1 className="text-sm text-primary">Day Money-Back Guarantee</h1>
          </div>
          <div className="">

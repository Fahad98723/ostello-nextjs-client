    ...
    <>
      <div className='lg:flex hidden bg-white rounded-xl shadow-lg '>
        ...
        >
          ...
          <h1
            className={`${categorySelected === 'Skills' ? 'block' : 'hidden'} text-sm ml-10`}
            onClick={() => {
              setIsExpand1(true)
              setIsExpand2(false)
              setIsExpand3(false)
          ...
          <h1
            ...
            onClick={() => {
              ...
              setIsExpand10(false);
              setIsExpand11(false);
              dispatch(setCategorySelected("SLAT"));
            }}
          >
            SLAT
          </h1>
          <h1
            ...
            onClick={() => {
              ...
              setIsExpand10(false);
              setIsExpand11(false);
              dispatch(setCategorySelected("CLAT"));
            }}
          >
            CLAT
          </h1>
          <h1
            ...
            onClick={() => {
              ...
              setIsExpand10(false);
              setIsExpand11(false);
              dispatch(setCategorySelected("CUET"));
            }}
          >
            CUET
          </h1>
      ...
      <div className=' lg:hidden '>
        ...
        >
          ...
          <h1
            className={`${categorySelected === 'Competitive Exams' ? 'block' : 'hidden'} text-sm ml-5`}
            onClick={() => {
              setIsExpand7(false)
              setIsExpand6(false)
              setIsExpand5(false)
          ...
          <div
            className={`${categorySelected === 'Skills' ? 'block' : 'hidden'} text-sm flex ml-5`}
            onClick={() => {
    ...
    >
      ...
      <div className='flex items-center space-x-3'>
        <input
          ...
          onChange={() => {}}
          name='Content Marketing'addCourseSelector
          className='text-lg lg:text-xl'
        />{' '}

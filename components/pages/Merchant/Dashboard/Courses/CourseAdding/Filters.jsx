...
export default function Filters({
  ...
  const uploadVideos = async () => {
    ...
    try {
      ...
      const videosUploaded = await SocketFileUploader(videoFiles);
      const thumbnailsUploaded = await SocketFileUploader(thumbnailFiles);
  ...
  const handleUploadImages = async () => {
    ...
    try {
      ...
      const images = await SocketFileUploader(imageFiles);
      console.log(images);

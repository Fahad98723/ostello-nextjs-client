...
export default function AdminMediaManager({
  ...
  const uploadVideos = async () => {
    ...
    try {
      let videosUploaded = await SocketFileUploader(videoFiles);
      let thumbnailsUploaded = await SocketFileUploader(thumbnailFiles);
            ...
            <div className="flex items-center flex-wrap">
              {images?.map((item, index) => (
                ...
                >
                  ...
                  <img
                    src={!item.url ? item : `https://cdn.ostello.co.in/${item?.key}`}
                    key={index}

...
import RenderEditorJS from "../../../CustomEditor/RenderEditorJS";
    ...
    <>
      ...
      <main className="my-20 px-6 max-w-5xl mx-auto">
        ...
        <section className=" space-y-4 my-10">
          <Image src={image?.url ?  `https://cdn.ostello.co.in/${image?.key}` : image} className="w-full h-full " alt={authorAlt} />

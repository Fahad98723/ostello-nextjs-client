                ...
                >
                  ...
                  >
                    <div className='border relative border-white rounded-xl overflow-hidden h-fit  aspect-video'>
                      ...
                      />
                      <div className=' group absolute top-5 right-5 md:top-10 md:right-10  bg-white flex rounded-lg gap-2 transition-all ease-in-out duration-300  cursor-pointer'>

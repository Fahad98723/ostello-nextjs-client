...
const Feature = () => {
    const data = [
        ...
        image:image1,
          ...
          title: 'Inclusive of all and any team size the customer service platform would help you balance everything your customers need.',
          desc: "sales@untitledui.com",
        },
        { image:image2,
          heading: 'Engage and develop your business',
          title: 'Measure your growth, analyze your sales statistics and get guided with report- backed data.',
          desc: 'support@untitledui.com',
        },
        { image:image3,
          heading: 'Establish your business profile and build a good customer base',
          title: 'Ostello is the place to be for you to launch your business, to establish your brand and to help students avail your services.',
        ...
        return (
          <>
            <div className='p-5 text-center  w-full' >
              ...
              <p className=' text-[16px] text-[#6941C6] mt-2 text-center justify-center flex items-center '>Learn More <AiOutlineArrowRight className='ml-2 ' /></p>
            </div>
          </>
        )
      }
    ...
    return (
        ...
        <button className='py-2 px-4 text-[16px] font-semibold text-[#6941C6] rounded-3xl bg-[#F9F5FF] '>Features</button>
  ...
  <div className="md:flex w-full mt-5">
    <img className='mr-[-50px] z-50 md:block hidden ' src={feature1.src} alt="" />
    <img className='z-40' src={feature2.src} alt="" />
  </div>

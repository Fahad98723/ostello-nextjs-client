...
const SingleCourse = ({ currentInstitute, currentCourse }) => {
  ...
  useEffect(() => {
    ...
    if(!recentCourse?.pricingdetails?.yearly?.effectiveprice && !recentCourse?.pricingdetails?.halfYearly?.effectiveprice && !recentCourse?.pricingdetails?.monthly?.effectiveprice){
      // setPriceRef('')
      setEffPrice(recentCourse?.effectiveprice);
      setGrossPrice(recentCourse?.grossprice);
      setEmiPrice(recentCourse?.emi);
    ...
    <>
      ...
      {currentCourse?.name ? (
        <div className="md:max-w-[1350px] mx-auto  py-5 px-5">
          <p className="text-4xl font-bold mb-5">{currentInstitute?.name}</p>
          {/* <p className="text-3xl mb-3">
            Courses
          </p> */}
          <div className="shadow-xl ">
            <div className="md:flex items-center md:max-w-[1350px] mx-auto ">
              <div className="md:w-2/4 pb-2">
                <p className="text-2xl font-bold ">{currentCourse?.name}</p>
              </div>

    ...
    <div className="container mx-auto lg:px-20 px-5 grid grid-cols-1 gap-y-5 mt-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 justify-center content-center gap-10 mt-5">
        ...
        <div key={index} className="flex bg-primary flex-col md:w-[300px] w-full  md:h-[344px] text-white text-start p-5 rounded">
          ...
          <Link href="#cuet-uni"
            >
             <a href="" className='bg-white w-full text-black text-center mt-6 xl:mb-0 py-1.5 px-2 cursor-pointer'>View Details</a> 
            </Link>
            <Link
              href="#cuet-program"
            >
              <p className='bg-primary text-center border border-white text-white w-full  mt-6 xl:mb-0 py-1.5 px-2 cursor-pointer'>Enroll Now</p>
            </Link>
          </div>
        </div>
        ))}

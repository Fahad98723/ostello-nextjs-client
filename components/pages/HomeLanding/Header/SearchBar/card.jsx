    ...
    <div
      onClick={() => {
        ...
        if (currentValue.type === "Exam") {
          dispatch(setExam([currentValue.name]));
          dispatch(setFields(""));
    ...
    >
      {currentValue.type === "institute" ? (
        <img
          ...
          className="w-[100px] h-[100px] my-auto lg:w-[100px]"
          alt={currentValue.name}
        />
      ) : (
        <div className="bg-primary w-[100px] h-[100px] my-auto lg:w-[100px] text-4xl rounded-xl flex items-center justify-center p-1 text-white cursor-pointer ">
      ...
      <div className="ml-2">
        ...
        {currentValue.type === "institute" ? (
          <div style={{ color: "#939393" }} className="text-base ">
            {getClassType(currentValue.classmode || currentValue.classtype)}
          </div>
        ) : (
          <div style={{ color: "#939393" }} className="text-base ">
        ...
        <div
          className={`${reviewClassHandler(currentValue.rating)}`}
          // style={{

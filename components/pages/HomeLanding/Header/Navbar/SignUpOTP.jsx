                ...
                <div className='flex text-white rounded-t-[5px] bg-primary h-[80px] justify-center items-center'>
                  <div
                   className='text-center flex flex-col w-full'>
                    ...
                    <p className="text-[12px] pr-3 pl-3 pb-5">You’re just one step away from signing up</p>
                  </div>
                </div>
                <div className="flex flex-col items-center bg-white pt-5 w-full">
                <h2 className="text-[#333232] font-bold text-center">OTP Verification</h2>
                <p className="text-[#333232] text-center mt-5">We have sent you an OTP on your mobile number XXXXXXXX{mobilenumber.slice(-4)}</p>

  ...
  return (
    <section className="mt-[200px] bg-gradient-to-r from-[#7C46FF] to-[#FF449B] md:w-full md:h-[520px] h-[663px] w-[433px]">
      ...
      <div className="md:flex justify-center hidden">
        ...
        <div className="md:flex items-center justify-center hidden gap-10 py-5">
        <div className="flex flex-col justify-center items-start md:w-[482px]">
            ...
            <p className="md:text-[16px] mx-5 flex-wrap my-5 text-white">Introducing Career Management for the Future : We strive to create a career that best suits you, by offering real-time mentor connectivity and with the help of our dynamic analytics which connects you to peers having similar career journeys and help you make informed decisions about your future.</p>
            <p className="md:text-[16px] mx-5 flex-wrap my-5 text-white">Career Our platform will help you map out your options and find the best path for you. The online marketplace include coaching institutes nearby, connect with mentor in 100 seconds, Ready to take control of your career?.</p>
            <button
          onClick={(e) => {
            if(!isAuthenticated){
              setOpen(true);

...
import { logout, setAuthModalState } from '../redux/slices/authSlice'
          ...
          {!isAuth ? (
            <React.Fragment>
                <button onClick={() => {
                  ...
                  }} className='lg:w-20 xl:w-32 xl:h-10 py-1 border-2 border-primary rounded bg-primary shadow-md transition-transform duration-100 ease-in-out hover:shadow-3xl  '>
            ...
            <React.Fragment>
              ...
              >
                <p className='font-medium text-base text-primary'>Logoutsss</p>
              </button>
            </React.Fragment>
          )}
        </div>
